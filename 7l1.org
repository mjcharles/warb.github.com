...
[[./img/python_ide.png]]
- Change the line 6 (they're numbered along the left-hand edge) to greet you by name rather than writing "Hello World".
- We can now put this program to our Micro:bit and see it work in the real World. Follow these instructions carefully:
  ...
  4. Click the *Download* button in the top-left hand corner of the browser window. After a few moments, you'll see a dialogue box appear. Drop down on the 'Save' button and click save as. Save the file in your ICT folder. 
  5. Open *My Computer* or a file explorer window, and navigate to your ICT folder...
